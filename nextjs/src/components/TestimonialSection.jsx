...
const TestimonialSection = () => {
  ...
  const testimonials = useMemo(
    () => publicListForDisplay(data?.testimonials, fallbackTestimonials),
    [data]
  );
              ...
              >
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 md:p-12 relative">
                  ...
                  <div className="flex items-center gap-4 mt-8">
                    {t.image ? (
                    <img
                      src={cloudinaryImgSrcForDisplay(t.image)}
                      alt=""
                      className="w-14 h-14 rounded-full object-cover border-2 border-primary"
                    />
                    ) : (
                      <div className="w-14 h-14 rounded-full border-2 border-primary bg-primary/20 shrink-0" aria-hidden />
                    )}
                    <div>
