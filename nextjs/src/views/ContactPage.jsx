...
const ContactPage = () => {
  ...
  const contactInfo = [
    ...
    { icon: Mail, title: 'Email Address', text: 'laabdanceacademy@gmail.com' },
    {
      icon: Clock,
      title: 'Working Hours',
                ...
                {contactInfo.map((info, i) => (
                  <div key={i} className="flex items-start gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 font-dm-sans text-sm mt-0.5 whitespace-pre-line">
                        {info.text}
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-[#f5f5f5] rounded-2xl p-8">
                ...
                {success ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 font-manrope mb-1.5">Message <span className="text-gray-400 font-normal">(optional)</span></label>
