...
const EventsPage = () => {
  ...
  const [events, setEvents] = useState(() => (isPublicCmsEnabled() ? [] : mockEvents));
  const [loading, setLoading] = useState(isPublicCmsEnabled());
        ...
        >
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              <span className="text-primary font-dm-sans text-sm uppercase tracking-widest">Events</span>
              <div className="w-10 h-[2px] bg-primary" />
            </div>
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    {!event.completed ? (
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/50 transition-all duration-500 flex items-center justify-center">
                        <button
                          type="button"
                          className="opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500 bg-primary text-white font-manrope font-semibold px-6 py-2.5 rounded-md text-sm"
                        >
                          Book Now
                        </button>
                      </div>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                      <div className="flex items-center gap-2 text-gray-400 min-w-0 flex-1">
                        ...
                        <span className="text-xs font-dm-sans truncate">{event.location}</span>
                      </div>
                      {event.price?.trim() ? (
