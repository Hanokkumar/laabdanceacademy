...
import { cloudinaryImgSrcForDisplay } from '../utils/cloudinaryImgSrc';
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="relative group">
              <div className="relative mx-auto max-w-lg lg:max-w-none min-h-[280px] sm:min-h-[340px]">
                <div className="overflow-hidden rounded-lg w-[88%] shadow-lg transition-transform duration-700 group-hover:scale-[1.02]">
                  <img
                    src={cloudinaryImgSrcForDisplay(imgMain)}
                    alt="LAAB Dance Academy"
                    className="w-full h-full object-cover aspect-[4/5] sm:aspect-[3/4]"
                  />
                </div>
                <div className="absolute bottom-0 right-0 w-[52%] max-w-[220px] overflow-hidden rounded-lg border-4 border-white shadow-xl transition-transform duration-700 group-hover:translate-y-[-4px]">
                  <img
                    src={cloudinaryImgSrcForDisplay(imgSecondary)}
                    alt="LAAB dancers and training"
