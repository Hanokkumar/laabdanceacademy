      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a
                  href="mailto:laabdanceacademy@gmail.com"
                  className="text-gray-400 font-dm-sans text-sm hover:text-primary transition-colors"
                >
                  laabdanceacademy@gmail.com
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 font-dm-sans text-sm">
              <li className="flex justify-between gap-4">
                <span>Mon – Sun</span>
                <span className="text-right shrink-0">9:00 AM – 10:00 PM</span>
              </li>
      ...
      <div className="border-t border-white/10 bg-black/20">
        <div className="max-w-7xl mx-auto px-4 pt-6 pb-28 sm:px-6 sm:pt-7 sm:pb-24 lg:pl-8 lg:pr-28 lg:pb-20">
          <div className="flex flex-col items-center gap-5 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
            ...
            <button
              type="button"
              onClick={() => { router.push('/admin'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
